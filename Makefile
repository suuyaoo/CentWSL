...
base.tar:
	...
	docker run --name centos8wsl centos:centos8 /bin/bash -c "dnf update -y; dnf install -y glibc-langpack-en; rpm -e --nodeps sudo; dnf clean all; pwconv; grpconv; chmod 0744 /etc/shadow; chmod 0744 /etc/gshadow;"
	docker export --output=base.tar centos8wsl
	docker rm -f centos8wsl
